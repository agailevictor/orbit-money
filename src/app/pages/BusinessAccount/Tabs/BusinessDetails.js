    ...
    <React.Fragment>
      <div id="BusinessDetails" className="card card-lg active" style={{ display: `${props.active ? "block" : "none"}` }}>
        <div className="card-body">
          ...
          <div className="form-group">
            <div className="row">
              <div className="col-md-12">
                <input type="text" className="form-control" name="" id="" placeholder="Orbit Investment Inc." />
              </div>
            </div>
          </div>
          <div className="form-group">
            <label className="small">Director:</label>
            <div className="row">
          ...
          <div className="form-group">
            <label className="small">Share Holders:</label>
            <div className="row">
              <div className="col-md-6">
                <input type="text" className="form-control" name="" id="" placeholder="First Name" />
              </div>
          ...
          <div className="form-group">
            <div className="row">
              <div className="col-md-6">
                <input type="text" className="form-control" name="" id="" placeholder="Registration No" />
              </div>
              <div className="col-md-6">
                <input type="text" className="form-control" name="" id="" placeholder="Tax Number" />
              </div>
            </div>
          </div>
