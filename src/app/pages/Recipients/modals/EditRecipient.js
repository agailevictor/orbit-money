...
class EditRecipient extends Component {
    ...
    constructor(props) {
        ...
        editRecipientSchema = this.getValidationObject();
    }

    componentDidMount() {
        this.fetchCountries();
        this.fetchCitiesByCountry(this.props.recipient.countryId);
        this.fetchCurrencies();
        this.fetchRecipientById(this.props.recipient.id);

        let requiredFields = [];
        if (this.props.recipient.hasOwnProperty("bankSWIFTBIC")) {
            requiredFields.push("bankSWIFTBIC");
        }

        if (this.props.recipient.hasOwnProperty("purposeOfPaymentCode")) {
            requiredFields.push("purposeOfPaymentCode");
        }

        if (this.props.recipient.hasOwnProperty("receiptPostalCode")) {
            requiredFields.push("receiptPostalCode");
        }

        if (this.props.recipient.hasOwnProperty("receiptRegionId")) {
            requiredFields.push("receiptRegionId");
        }

        this.setState({ recipientRequiredFields: requiredFields })

    }

    fetchRecipientById(recipientId) {
        this.setState({ showLoader: true });
        callApi("POST", ApiConstants.RECIPIENTS_FETCH_BY_ID, { id: recipientId })
            .then((response) => {

                console.log(response);

                if (response.code === 200) {
                    this.setState({ showLoader: false, recipientToUpdate: recipientId });
                    this.setState({ defaultCountry: { label: this.props.recipient.country, value: this.props.recipient.countryId } });
                }
    ...
    getValidationObject() {
        ...
        if (this.isFieldRequired("bankSWIFTBIC")) {
            validationObject.bankSWIFTBIC = Yup.string().required(t("Recipients.AddRecipient.BankSWIFTBICRequiredValidationLabel"));
        }
                ...
                >
                    ...
                    <Modal.Body>
                        <Formik
                            ...
                            validationSchema={editRecipientSchema}
                            onSubmit={async (values) => {

                                let recipient = {
                                    "id": this.props.recipient.id,
                                    "vendorId": this.props.recipient.vendorId,
                                ...
                                if (this.isFieldRequired("bankSWIFTBIC")) {
                                    recipient.bankSWIFTBIC = values.bankSWIFTBIC;
                                }
                                ...
                                this.setState({ showLoader: true });
                                callApi("put", ApiConstants.ADD_RECIPIENTS, recipient)
                                    .then((response) => {
                                        console.log(response);
                                        if (response.code === 200) {
                                                    ...
                                                    <li>
                                                        <div className={`form-group ${errors.countryId ? "is-invalid" : ""}`}>
                                                            <CountryList name="countryId"
                                                                ...
                                                                defaultValue={{ label: this.props.recipient.country, value: this.props.recipient.countryId }}
                                                    ...
                                                    <li>
                                                        ...
                                                        <div className={`form-group ${errors.currencyId ? "is-invalid" : ""}`}>
                                                            <Select2 name="currencyId"
                                                                ...
                                                                defaultValue={{ label: this.props.recipient.currency, value: this.props.recipient.currencyId }}
                                            ...
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    <div className="row">
                                                        ...
                                                        {this.isFieldRequired("bankSWIFTBIC") &&
                                                            <div className="col-md-6">
                                                                <div className="form-group">
                                                                    <FormikField
                                                                        type="text"
                                                        ...
                                                        <div className="col-md-6">
                                                            ...
                                                            <div className={`form-group ${errors.cityId ? "is-invalid" : ""}`}>
                                                                <Select2 name="cityId"
                                                                    ...
                                                                    defaultValue={{ label: this.props.recipient.city, value: this.props.recipient.cityId }}
                                                                ...
                                                                <div className="col-md-6">
                                                                    ...
                                                                    <div className={`form-group ${errors.purposeOfPaymentCode ? "is-invalid" : ""}`}>
                                                                        <Select2 name="purposeOfPaymentCode"
                                                                            ...
                                                                            defaultValue={{ label: this.props.recipient.purposeOfPayment, value: this.props.recipient.purposeOfPaymentId }}
...
export default connect(mapStateToProps)(withTranslation()(EditRecipient));